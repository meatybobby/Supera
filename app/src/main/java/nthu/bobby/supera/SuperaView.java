 ...
 */
public class SuperaView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public SuperaView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public SuperaView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (SuperaView.this) {
                    try {
                        SuperaView.this.wait();
                    } catch (InterruptedException e) {
